...
pop_hist_data %>%
  ...
  ggtitle("Histograms of Log Populaiton of City Observations Included in the\nVarious Regression Analyses") +
...
fit_fs_pop_top_1 <- with(imp_fs_pop_top_1, felm(dgepercap_cpi ~ H_citytract_NHW_i + diversityinterp + pctblkpopinterp + pctasianpopinterp + pctlatinopopinterp + medinc_cpi + pctlocalgovworker_100 + pctrentersinterp + pctover65 + pctcollegegradinterp + logpop | factor(geo_id2) |0| geo_id2))
...
fin_seg %>%
  ggplot(aes(x = logpop)) +
  geom_histogram() +
  geom_vline(aes(xintercept = log(25000)))
...
fit_imp_bottom_60 <- with(imp_bottom_60, felm(dgepercap_cpi ~ H_citytract_NHW_i + diversityinterp + pctblkpopinterp + pctasianpopinterp + pctlatinopopinterp + medinc_cpi + pctlocalgovworker_100 + pctrentersinterp + pctover65 + pctcollegegradinterp + logpop | factor(geo_id2) |0| geo_id2))
...
fit_imp_50k <- with(imp_50k, felm(dgepercap_cpi ~ H_citytract_NHW_i + diversityinterp + pctblkpopinterp + pctasianpopinterp + pctlatinopopinterp + medinc_cpi + pctlocalgovworker_100 + pctrentersinterp + pctover65 + pctcollegegradinterp + logpop | factor(geo_id2) |0| geo_id2))
...
fit_imp_250k <- with(imp_250k, felm(dgepercap_cpi ~ H_citytract_NHW_i + diversityinterp + pctblkpopinterp + pctasianpopinterp + pctlatinopopinterp + medinc_cpi + pctlocalgovworker_100 + pctrentersinterp + pctover65 + pctcollegegradinterp + logpop | factor(geo_id2) |0| geo_id2))
...
coef.labels <- c("Diversity", "White/Non-White Seg. Index")
names(coef.labels) <- c("Diversity", "White/Non-White Seg. Index")

...
fin_imp_aggr <- fin_imp %>%
  select(ideology_fill, H_citytract_NHW_i, chng5pctblk, chng5pctlatino, chng5pctasian, diversityinterp, pctblkpopinterp, pctasianpopinterp,
         pctlatinopopinterp, medinc_cpi, pctlocalgovworker_100, pctrentersinterp, pctover65,
...
title(main = "Patterns of Missingness in the Financial Segregation Data",
      sub = "Is this a caption? qiufwnjekfewkfnwein\nwefjwenmf wiufnwqjenf ewfuiwjnef nfijefnwjenfkqwjnf lqwjefnjqwefjwnef winfjqwhf hjwefwiuefief welfiunqlfjnqkjwe qqfniquwenjfjq iqfnjkjeq rfiunfj q")
...
```{r main_fp_tables, results = "asis", eval = FALSE}

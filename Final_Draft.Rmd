...
t1 <- stargazer(m1, m2, m3, omit = c("year", "south", "midwest", "west"),
                ...
                notes = "This table displays the results of the replication effort of the analyses conducted in Trounstine (2016) using the racial polarization dataset. The replication code can be found on my personal Github repository, which is linked in the introduction. The original table is displayed for comparison as Figure 1.)")

...
gg_miss_var(rp_impute, show_pct = TRUE) +
  ggtitle("% Missing Values in Trounstine (2016)'s Racial\nPolarization Dataset") +
  labs(caption = ",jweh,rbguywaflkwanejkfhbwa,keifjlqwibfkjqwhbsfjkhwbsdwhqefhgwef") +
...
aggr(rp_aggr, bars = TRUE, combined = T, col=c('navyblue','red'), numbers=TRUE, cex.axis=.5, gap=1, ylab=c("Proporiton of Missing Values","Combinations"))
title(main = "Patterns of Missingness in the Financial Segregation Data",
      sub = "", line = 3, oma = c(1,3,5,1))

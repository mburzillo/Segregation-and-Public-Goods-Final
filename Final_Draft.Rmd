...
```{r fp_imputations_original, eval = FALSE, include = FALSE}
...
kable(imp_1_rp_sum_table_vars, "latex", caption = "\\textbf{Racial Polarization in Segregated Cities: Racial Divide with Multigroup Segregation Index}", booktabs = T) %>%
  ...
  footnote(general = "this is my second caption to see if this works and how i will need to deal with newjhfhfjhbcjhwbrjfnwmfnirfjnwmfwkfnj wfjwjenfkwejwefhwefb",

...
aggr(fin_imp_aggr, plot = TRUE, bars = TRUE, col=c('navyblue','red'), numbers= FALSE, cex.axis=.4, gap=2, ylab=c("Proporiton of Missing Values","Combinations"), srt = 45)
title(main = "Patterns of Missingness in the Financial Segregation Data",
      sub = "", font.main = 1, font.axis = 1, cex.main = 1, line = 3,  oma = c(1,3,5,1), font.main = 1, font.axis = 1, srt = 45)
